...
> **Version**: 0.1.0 · repo: https://github.com/kouljihate/FarmSimulator
...
right. Styling is **Tailwind CSS** (CDN). The home page has a tab bar — **Part
1** (the upload flow) plus **Tab 2 … Tab 6** placeholders (future parts).
