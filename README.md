...
> **Version**: 0.4.5 · repo: https://github.com/kouljihate/FarmSimulator
...
2. The app parses the land boundary and water point, then shows the basin +
   3 sectorisation suggestions in an **Upload Result card** that appears in the
   **Basin tab** on the same page.
