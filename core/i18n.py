...
EN = {
    ...
    "MAJORS": "majors 63 mm",
    "MINORS": "minors 32 mm",
    "VALVE_PRINCIPAL": "Main valve 90 mm",
    "VALVE_SECONDARY": "Zone valve 32 mm",
    ...
    "VALVE_SELECT_ALL": "Select ALL",
    "VALVE_UNSELECT_ALL": "Unselect ALL",
    ...
    "CONFIRM_RECAP": "Confirm recap",
    "CONFIRM_RECAP_HINT": "Confirm the recap map to unlock the Final Result tab.",
    "RECAP_CONFIRMED": "Recap confirmed — Final Result unlocked",
    "FINAL_LOCKED": "Final Result is locked until the recap is confirmed.",
    "FINAL_LOCKED_HINT": "The Final Result tab unlocks after you confirm this recap.",
    "CONFIRM_ROWS": "Confirm Rows",
    "ROWS_CONFIRMED": "Rows confirmed",
    "ROWS_PENDING": "Rows pending confirmation",
    "ACTIONS": "Actions",
    "PRINCIPAL": "Main Valve",
    "SECONDARY": "Zone Valve",
    "KIND": "Type",
    "SECTOR": "Sector",
    ...
    "STEP_VALVES": "Valves - 3 main valves (MV1 = S1-S5, MV2 = S6-S7, MV3 = S8) plus one 32 mm zone valve per zone.",
...
AR = {
    ...
    "VALVE_SECONDARY": "صمام المنطقة 32 مم",
    ...
    "VALVE_SELECT_ALL": "تحديد الكل",
    "VALVE_UNSELECT_ALL": "إلغاء تحديد الكل",
    ...
    "CONFIRM_RECAP": "تأكيد الملخص",
    "CONFIRM_RECAP_HINT": "أكّد خريطة الملخص لفتح تبويب النتيجة النهائية.",
    "RECAP_CONFIRMED": "تم تأكيد الملخص — فُتحت النتيجة النهائية",
    "FINAL_LOCKED": "النتيجة النهائية مقفلة حتى تأكيد الملخص.",
    "FINAL_LOCKED_HINT": "يُفتح تبويب النتيجة النهائية بعد تأكيد هذا الملخص.",
    "CONFIRM_ROWS": "تأكيد الصفوف",
    "ROWS_CONFIRMED": "تم تأكيد الصفوف",
    "ROWS_PENDING": "بانتظار تأكيد الصفوف",
    "ACTIONS": "إجراءات",
    "PRINCIPAL": "الصمام الرئيسي",
    "SECONDARY": "صمام المنطقة",
    "KIND": "النوع",
    "SECTOR": "القطاع",
