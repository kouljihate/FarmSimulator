...
EN = {
    ...
    "VALVE_DRAG_HINT": "Select one sector to show only it — drag its valves, then Save. With all sectors, drags save instantly.",
    ...
    "VALVE_SECTOR_FILTER": "Work on one sector",
...
AR = {
    ...
    "VALVE_DRAG_HINT": "اختر قطاعاً واحداً لعرضه فقط — اسحب صماماته ثم احفظ. مع كل القطاعات، يُحفظ السحب فوراً.",
    "VALVE_SELECTED": "الصمام المحدد",
    "VALVE_INFO_EMPTY": "انقر على علامة صمام في الخريطة (أو زر التعديل في الجدول) لعرض تفاصيله هنا.",
    "VALVE_SECTOR_FILTER": "العمل على قطاع واحد",
