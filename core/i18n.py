...
EN = {
    ...
    "VALVE_DRAG_HINT": "Click a valve to select it — drag any valve marker to move it. Click empty map to fill new-valve coordinates.",
    "VALVE_SELECTED": "Selected valve",
    "VALVE_INFO_EMPTY": "Click a valve marker on the map (or pick one below) to see its details here.",
    "KIND": "Type",
    "SECTOR": "Sector",
...
AR = {
    ...
    "VALVE_DRAG_HINT": "انقر على صمام لتحديده — اسحب أي علامة صمام لنقله. انقر على خريطة فارغة لملء إحداثيات صمام جديد.",
    "VALVE_SELECTED": "الصمام المحدد",
    "VALVE_INFO_EMPTY": "انقر على علامة صمام في الخريطة (أو اختر واحداً أدناه) لعرض تفاصيله هنا.",
    "KIND": "النوع",
    "SECTOR": "القطاع",
