...
EN = {
    ...
    "VALVE_DRAG_HINT": "Select one zone to show only it — drag its valves, then Save. With all zones, drags save instantly.",
    ...
    "VALVE_ZONE_FILTER": "Work on one zone",
    "VALVE_ALL_ZONES": "All zones",
...
AR = {
    ...
    "VALVE_DRAG_HINT": "اختر منطقة واحدة لعرضها فقط — اسحب صماماتها ثم احفظ. مع كل المناطق، يُحفظ السحب فوراً.",
    "VALVE_SELECTED": "الصمام المحدد",
    "VALVE_INFO_EMPTY": "انقر على علامة صمام في الخريطة (أو زر التعديل في الجدول) لعرض تفاصيله هنا.",
    "VALVE_ZONE_FILTER": "العمل على منطقة واحدة",
    "VALVE_ALL_ZONES": "كل المناطق",
